...
import { av_char_64, av_pr, av_enc_functions, av_dec_functions, av_create_buffer } from './core.js'

const avCustom64 = new AvCustom64(av_char_64)
...
export const create_key = (k) => avCustom64
    .encode(k)
    .split('')
...
export const encode64 = (str) => avCustom64.encode(str)

export const decode64 = (str) => avCustom64.decode(str)
